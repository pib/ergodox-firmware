...
#define  ctrlpr   &kbfun_ctrl_press_release
...
KB_MATRIX_LAYER(
	...
	KEY_a_A,	KEY_z_Z,	KEY_x_X,	KEY_c_C,	KEY_v_V,
	KEY_PrintScreen,	1,	
	0,	0,	KEY_F11,	
	KEY_DeleteBackspace,	KEY_LeftShift,	KEY_DeleteForward,	
	// right hand
	KEY_Dash_Underscore,	KEY_6_Caret,	KEY_7_Ampersand,	KEY_8_Asterisk,	KEY_9_LeftParenthesis,	KEY_0_RightParenthesis,	KEY_Backslash_Pipe,	
	KEY_F5,	KEY_y_Y,	KEY_j_J,	KEY_f_F,	KEY_l_L,	KEY_p_P,	KEY_Semicolon_Colon,	
	KEY_k_K,	KEY_n_N,	KEY_e_E,	KEY_o_O,	KEY_i_I,	KEY_Slash_Question,	
	KEY_CapsLock,	KEY_SingleQuote_DoubleQuote,	KEY_u_U,	KEY_Comma_LessThan,	KEY_Period_GreaterThan,	KEY_UpArrow,	KEY_f_F,
	KEY_Home,	KEY_End,	KEY_LeftArrow,	KEY_DownArrow,	KEY_RightArrow,	
...
KB_MATRIX_LAYER(
	...
	0,	
	// left hand
	KEY_GraveAccent_Tilde,	KEY_1_Exclamation,	KEY_2_At,	KEY_3_Pound,	KEY_4_Dollar,	KEY_5_Percent,	KEY_F11,	
	...
	KEY_LeftControl,	KEY_LeftGUI,	KEY_LeftAlt,	0,	0,	
	KEY_PrintScreen,	2,	
	0,	0,	KEY_F11,	
	KEY_DeleteBackspace,	KEY_LeftShift,	KEY_DeleteForward,	
	// right hand
	KEY_F12,	KEY_6_Caret,	KEY_7_Ampersand,	KEY_8_Asterisk,	KEY_9_LeftParenthesis,	KEY_0_RightParenthesis,	KEY_Dash_Underscore,	
	KEY_F5,	KEY_y_Y,	KEY_u_U,	KEY_i_I,	KEY_o_O,	KEY_p_P,	KEY_LeftBracket_LeftBrace,	
	KEY_h_H,	KEY_j_J,	KEY_k_K,	KEY_l_L,	KEY_Semicolon_Colon,	KEY_SingleQuote_DoubleQuote,	
	KEY_CapsLock,	KEY_b_B,	KEY_n_N,	KEY_m_M,	KEY_Comma_LessThan,	KEY_Period_GreaterThan,	KEY_Slash_Question,	
	0,	0,	KEY_RightAlt,	KEY_RightGUI,	KEY_LeftControl,	
	KEY_LeftBracket_LeftBrace,	KEY_RightBracket_RightBrace,	
	KEY_PageUp,	0,	0,	
	KEY_PageDown,	KEY_ReturnEnter,	KEY_Spacebar	
),
...
KB_MATRIX_LAYER(
	...
	kprrel,	kprrel,	kprrel,	kprrel,	kprrel,	kprrel,	kprrel,	
	ctrlpr,	ctrlpr,	ctrlpr,	ctrlpr,	ctrlpr,
	kprrel,	lpush1,	
	NULL,	NULL,	kprrel,	
	...
	kprrel,	kprrel,	kprrel,	kprrel,	kprrel,	kprrel,	kprrel,	
	kprrel,	kprrel,	kprrel,	kprrel,	kprrel,	kprrel,	
	kprrel,	kprrel,	kprrel,	kprrel,	kprrel,	kprrel,	ctrlpr,
